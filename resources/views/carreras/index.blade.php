...
@section('content')
    <div class="container">
        ...
        @can('crud-create-career')
            <a class="btn btn-primary" href="{{ route('carreras.create') }}">Agregar Carrera</a>
        @endcan
        @if (session('success'))
            ...
            <tbody>
                @foreach ($carreras as $carrera)
                    <tr>
                        ...
                        <td>
                            @can('crud-show-career')
                                <a style="text-decoration: none;" href="{{ route('carreras.show', $carrera->id) }}">
                            ...
                            @endcan
                            @can('crud-edit-career')
                                <a style="text-decoration: none;" href="{{ route('carreras.edit', $carrera->id) }}">
